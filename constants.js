...
// ─── TRADE LOG ───────────────────────────────────────────────────────────────
const TRADE_LOG = [
    { season: 4, year: 2026, trades: [
        { week: 3, team1: 'Southie Thunder Buddies', team2: 'Lake Champlain Champs', description: 'Traded pick 2.07 for pick 1.09' },
        { week: 5, team1: 'Point Pleasant Mothmen', team2: 'Bikini Bottom Angry Birds', description: 'Traded DJ Moore for 2027 1st round pick' },
    ]},
    { season: 3, year: 2025, trades: [
        { week: 2, team1: 'Driftwood Broncos', team2: 'Southie Thunder Buddies', description: 'Traded Ja\'Marr Chase for multiple picks' },
        { week: 6, team1: 'New England Blinkahs', team2: 'Mar a Lago Bed Bugs', description: 'Swapped draft picks (2025 round 1)' },
    ]},
];

// ─── PLAYOFF HISTORY ──────────────────────────────────────────────────────────
const PLAYOFF_HISTORY = [
    { season: 3, year: 2025, champion: 'Southie Thunder Buddies', runnerUp: 'Lake Champlain Champs', bracket: [
        { round: 'Championship', week: 16, team1: 'Southie Thunder Buddies', score1: 156.7, team2: 'Lake Champlain Champs', score2: 134.2, winner: 'Southie Thunder Buddies' },
    ]},
    { season: 2, year: 2024, champion: 'Driftwood Broncos', runnerUp: 'Southie Thunder Buddies', bracket: [
        { round: 'Championship', week: 16, team1: 'Driftwood Broncos', score1: 135.6, team2: 'Southie Thunder Buddies', score2: 131.2, winner: 'Driftwood Broncos' },
    ]},
];

// ─── DRAFT HISTORY ────────────────────────────────────────────────────────────
const DRAFT_HISTORY = [
    { season: 4, year: 2026, type: 'Rookie', date: 'April 2026', topPicks: [
        { pick: 1, team: 'The Bog Cloggers', player: 'TBD' },
        { pick: 2, team: 'London Silly Nannies', player: 'TBD' },
        { pick: 3, team: 'Puddletown Panthers', player: 'TBD' },
    ]},
];

// ─── WAIVER WIRE ACTIVITY ─────────────────────────────────────────────────────
const WAIVER_LOG = [
    { week: 9, date: '2026-05-14', transactions: [
        { type: 'add', team: 'Southie Thunder Buddies', player: 'Jaylen Warren', position: 'RB', dropped: 'None' },
        { type: 'add', team: 'Point Pleasant Mothmen', player: 'Marvin Jones Jr', position: 'WR', dropped: 'Khalil Shakir' },
    ]},
];

// ─── SEASON PROJECTIONS ──────────────────────────────────────────────────────
// These are updated weekly based on current standings and remaining schedule
const SEASON_PROJECTIONS = {
    season: 4,
    year: 2026,
    week: 9,
    projections: [
        { team: 'Southie Thunder Buddies', wins: 12, losses: 3, projectedRecord: '14-1', confidence: 95 },
        { team: 'Lake Champlain Champs', wins: 10, losses: 5, projectedRecord: '12-3', confidence: 85 },
        { team: 'Point Pleasant Mothmen', wins: 9, losses: 6, projectedRecord: '11-4', confidence: 80 },
        { team: 'New England Blinkahs', wins: 8, losses: 7, projectedRecord: '10-5', confidence: 75 },
        { team: 'Mar a Lago Bed Bugs', wins: 7, losses: 8, projectedRecord: '9-6', confidence: 70 },
        { team: 'Bikini Bottom Angry Birds', wins: 7, losses: 8, projectedRecord: '9-6', confidence: 70 },
        { team: 'The Catalina Wine Mixer\'s', wins: 6, losses: 9, projectedRecord: '8-7', confidence: 65 },
        { team: 'Driftwood Broncos', wins: 5, losses: 10, projectedRecord: '7-8', confidence: 60 },
        { team: 'Wukanda dolphins', wins: 5, losses: 10, projectedRecord: '7-8', confidence: 60 },
        { team: 'Mooloolaba Love Tanks', wins: 4, losses: 11, projectedRecord: '6-9', confidence: 50 },
        { team: 'Rhody Quahogs', wins: 3, losses: 12, projectedRecord: '5-10', confidence: 45 },
        { team: 'CT Cool Catz', wins: 3, losses: 12, projectedRecord: '5-10', confidence: 45 },
    ]
};

// ─── PLAYOFF PROBABILITY ─────────────────────────────────────────────────────
// Calculated chance of making playoffs based on current record and remaining games
const PLAYOFF_ODDS = {
    season: 4,
    year: 2026,
    week: 9,
    odds: [
        { team: 'Southie Thunder Buddies', playoffProb: 99, byeProb: 90 },
        { team: 'Lake Champlain Champs', playoffProb: 98, byeProb: 75 },
        { team: 'Point Pleasant Mothmen', playoffProb: 95, byeProb: 60 },
        { team: 'New England Blinkahs', playoffProb: 85, byeProb: 40 },
        { team: 'Mar a Lago Bed Bugs', playoffProb: 70, byeProb: 20 },
        { team: 'Bikini Bottom Angry Birds', playoffProb: 68, byeProb: 18 },
        { team: 'The Catalina Wine Mixer\'s', playoffProb: 40, byeProb: 5 },
        { team: 'Driftwood Broncos', playoffProb: 25, byeProb: 2 },
        { team: 'Wukanda dolphins', playoffProb: 22, byeProb: 1 },
        { team: 'Mooloolaba Love Tanks', playoffProb: 8, byeProb: 0 },
        { team: 'Rhody Quahogs', playoffProb: 5, byeProb: 0 },
        { team: 'CT Cool Catz', playoffProb: 3, byeProb: 0 },
    ]
};

// ─── ADMIN CONFIGURATION ─────────────────────────────────────────────────────
// IMPORTANT: Change this password before going live!
const ADMIN_PASSWORD = '4dbfantasy';  // ← CHANGE THIS TO YOUR OWN PASSWORD
